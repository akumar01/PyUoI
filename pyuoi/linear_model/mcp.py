...
class PycMCP():
    """class PycMCP: MCP using the pycasso solver. Solves for an
...
class UoI_MCP(AbstractUoILinearRegressor, LinearRegression):
    """ UoI MCP model.
    ...
    eps : float, default 1e-3
        Length of the mcp path. eps=1e-3 means that
